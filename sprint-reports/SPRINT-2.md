...
- Built the Notification Worker — subscribes to purchases:confirmed pub/sub, calls the Notification Service via POST /notify on each confirmed purchase, exposes /health endpoint on port 3006 with Redis check, last_job_at and jobs_processed tracking.
...
| Sidharth       | Notifaction Service, Notification worker                                                                                                                                                                                                                         | [PR #23](https://github.com/ginpks/team-1-ticketing/pull/23)                                                                                                                                                                                                                |
